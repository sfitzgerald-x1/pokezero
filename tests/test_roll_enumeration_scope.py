...
class RollEnumerationMentionLedger(unittest.TestCase):
    ...
    _MENTION_ALLOWLIST = {
        ...
        # C147 runs the SAME probe, unchanged, on two builds -- `origin/main` and the
        ...
        "reports/artifacts/c147_g33b_row_replay_base.json",
        "reports/artifacts/c147_g33b_row_replay_gate.json",
        # And the same replay re-run on both sides of the `f1c3b3aa` merge, because #1166
        # changes the engine (72 patches) and the renderer, so the pre-merge pair no longer
