...
class RootPUCTTelemetryTest(unittest.TestCase):
        ...
        telemetry = root_puct_decision_telemetry(
            {
                ...
                "root_puct_timing": {
                    ...
                    "puct_search_completed_call_seconds": 0.08,
                    "puct_search_completed_call_count": 1,
                    "puct_search_retained_completed_call_seconds": 0.08,
                    "puct_search_retained_completed_call_count": 1,
                    "puct_search_completed_result_seconds": 0.07,
                    "puct_search_completed_result_count": 1,
                    "puct_search_completed_call_overhead_seconds": 0.01,
                    "puct_search_discarded_completed_call_seconds": 0.0,
                    "puct_search_discarded_completed_call_count": 0,
                    "puct_search_rejected_call_seconds": 0.02,
    ...
    def test_summary_reports_fallbacks_taxonomy_visits_and_wall_samples(self) -> None:
            ...
            (
                {
                    ...
                    "timing": {
                        ...
                        "adaptive_reused_root_branch_count": 3,
                    },
                },
                {
                    "outcome": "fallback",
                    ...
                    "timing": {
                        ...
                        "adaptive_reused_root_branch_count": 2,
                    },
                    "counters": {
                        "root_puct_direct_materialization_rejection_categories": {
        ...
        self.assertEqual(report["timing_totals"]["adaptive_reused_root_branch_count"], 5)
