...
class NeuralPolicyScaffoldTest(unittest.TestCase):
    ...
    def test_neural_cli_root_puct_play_benchmark_summary_out_persists_json(self) -> None:
        ...
        fake_training_result = SimpleNamespace(
            model_config=SimpleNamespace(policy_id="neural-smoke", window_size=1, format_id="gen3randombattle", stats_block_enabled=True, exact_state_enabled=True, transition_token_budget=128, tier2_residuals=True)
        )
    ...
    def test_neural_cli_root_puct_play_benchmark_can_average_checkpoint_opponent_action_scenarios(self) -> None:
        ...
        fake_model = object()
        fake_training_result = SimpleNamespace(model_config=SimpleNamespace(policy_id="neural-smoke", window_size=1, stats_block_enabled=True, exact_state_enabled=True, transition_token_budget=128, tier2_residuals=True))
        captured = {}
    ...
    def test_neural_cli_root_puct_benchmark_wires_checkpoint_callbacks_and_source_policies(self) -> None:
        ...
        fake_training_result = SimpleNamespace(
            model_config=SimpleNamespace(
                ...
                exact_state_enabled=True, transition_token_budget=128, tier2_residuals=True,
            )
        )
        captured = {}
