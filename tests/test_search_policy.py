...
class RootPUCTSearchPolicyTest(unittest.TestCase):
    ...
    def test_root_puct_policy_uses_default_world_when_belief_samples_reject(self) -> None:
        branch_envs: list[RejectingStartOverrideOutcomeEnv] = []
        planner_calls: list[tuple[str, int]] = []
        ...
        self.assertEqual(metadata["root_puct_start_override_attempts_used"], 2)
        self.assertEqual(metadata["root_puct_start_override_default_world_fallbacks_used"], 1)
        self.assertEqual(metadata["root_puct_opponent_action_scenarios_generated"], 2)
        ...
        self.assertEqual(
            metadata["root_puct_opponent_action_scenarios"],
            [{"label": "stay-in/default-world-fallback", "weight": 1.0, "actions": {"p2": 0}}],
        )
    ...
    def test_root_puct_policy_reports_start_override_attempts_on_default_world_fallback(self) -> None:
        branch_envs: list[RejectingStartOverrideOutcomeEnv] = []
        ...
        self.assertEqual(decision.metadata["root_puct_start_override_default_world_fallbacks_used"], 1)
        self.assertEqual(branch_envs[0].rejected_start_overrides, 3)
