...
# Appendix Z9 — Batch E (patches 37-41): five mechanisms, two family labels inverted, and the recoil exactness trade
...
## Z9.1 E1 — the family label was wrong for BOTH rows, two different ways
...
## Z9.2 E2/E3 — recoil exactness and weather-move targeting (patches 38, 37)
...
## Z9.3 E4 — the fixed-damage path skipped the ENTIRE post-damage suite (patch 39)
...
## Z9.4 E5 — gen3 Counter/Mirror Coat treat Hidden Power as PHYSICAL (patch 40)
...
## Z9.6 Prediction and the identity diff (registered FIRST, separate commit)
...
## Z9.7 Coverage statement and artifacts
...
- The documented BP-side one-point loci (pinch abilities, Thick Fat, Facade,
  ...
  E1's two rows both decomposed elsewhere (Z9.1).
