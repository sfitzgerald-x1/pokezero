...
- Append-only promotion registry for recording gate-passing checkpoints and their full gate evidence.
...
- Evaluation exists against fixed baselines and historical checkpoints, with configurable absolute-floor and incumbent-delta promotion gates plus a promotion registry; long-run experiment criteria are still informal.
