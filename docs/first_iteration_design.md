...
- Source provenance snapshots in teacher bootstrap, linear self-play, neural self-play, CPU smoke, and CPU pilot-suite artifacts, including repo root, branch, head, and dirty marker when git metadata is available.
