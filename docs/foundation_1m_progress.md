...
but non-collapsed. From 630k through 760k, scheduled max-damage reads mostly held in the high 50s to
...
scheduled band, the 750k row held nearby at 57.8%, and the 760k row rebounded to 60.2%. The completed
non-foul high-fidelity max-damage leg at 600k is 1,116 / 2,000 (55.8%), below the co-located 600k
scheduled row's 59.8%, so treat the latest scheduled rows as constructive but still provisional
until future complete high-fidelity rows corroborate the broader trend.
