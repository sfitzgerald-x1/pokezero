...
anchor into a high-50s/low-60s band. From 630k through 891k, scheduled max-damage reads mostly held
...
880k row edged up to 62.2%. The 891k row then reached 63.0%, continuing the recent low-60s band.
...
max-damage strength before treating it as a durable breakthrough. The 870k, 880k, and 891k scheduled
foul-play reads were 6 / 100, 4 / 100, and 4 / 100, which remain consistent with the
lagging-benchmark interpretation. The next meaningful check is whether max-damage holds or improves
as the run crosses later 10k thresholds, and whether complete higher-fidelity 50k reads show the same
trend while foul-play remains tracked for delayed movement.
