...
- **E0 — search strength benchmark (harness built; result pending).** The preferred full-game
  ...
  with Wilson intervals and a diagnostic-only marker for reads below 300 paired games. The lower-level
