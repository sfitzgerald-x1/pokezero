...
1. Run an expanded cold-start versus teacher-bootstrap comparison with a feasible promotion gate profile and the provisional envelope thresholds from the early comparison.
