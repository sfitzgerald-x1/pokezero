...
2. Expand the passing adjusted-guardrail comparison only after deciding whether cold-start or teacher-bootstrap should be the next incumbent candidate.
