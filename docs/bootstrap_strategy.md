...
- Track benchmark win rate, capped-game rate, validation fit, games per hour, average decision-round length, and best-effort peak RSS for both paths. Treat validation fit as imitation-health only.
