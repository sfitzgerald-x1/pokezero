...
The rows below are the only live evidence for the current parity-repaired
...
why this recheck is required.

| Cycle | Public revision | Schema | Layer | Status | Aggregate artifact |
| --- | --- | --- | --- | --- | --- |
| 2026-07-20 | `e865d7b473add41176318d680c62b23952636b6d` | v3 | Exact universe, bounded-depth, and party fixtures | Running: static gate first, then depth and party | Pending persistent-job terminal artifact |
| 2026-07-20 | `e865d7b473add41176318d680c62b23952636b6d` | v3 | Silent engine-mutation lane | Running | Pending persistent-job terminal artifact |
| 2026-07-20 | `e865d7b473add41176318d680c62b23952636b6d` | v3 | E/O/C protocol inventory and census differential | Queued behind fresh coverage terminal artifact | Pending |
| 2026-07-20 | `e865d7b473add41176318d680c62b23952636b6d` | v3 | Encoding-collision capture and audit | Queued behind fresh coverage recheck | Pending |
| 2026-07-20 | `e865d7b473add41176318d680c62b23952636b6d` | v3 | Counterfactual harm probes | Runs only for the validated shortlist | Not started |
...
parity-repaired revision. Neither result is a claim of exhaustive battle-state
coverage.
...
| Live Tier-2/investment annotations differ from a bare batch fold | Bounded depth | 6,111 of 6,159 fresh dynamic divergences | 6,111; fresh v3 coverage aggregate | Live path applies incremental Tier-2/investment overlays; batch oracle currently does not | Numeric differences include the Tier-2 residual and validity columns | Repair batch-equivalent annotation oracle, then re-run | PENDING AUDIT REPAIR | Fresh bounded-depth command after oracle repair |
| Castform Forecast form identity | Party fixture | 4 bridge-oracle divergences | 4; fresh v3 coverage aggregate | Encoder intentionally retains base `Castform` and updates live type slots | Existing oracle incorrectly demands `Castform-Rainy`/other form species identity | Correct oracle to assert base identity plus retyped slots | PENDING AUDIT REPAIR | `castform_forecast_formechange` fixture |
| Ditto Transform token identity | Party fixture | 2 bridge-oracle divergences | 2; fresh v3 coverage aggregate | Under investigation | May be a transformed-state matching issue or a production encoding gap | Minimize fixture and compare serialized transform state with token identity | PENDING | `ditto_transform` fixture |
