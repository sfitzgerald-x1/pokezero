...
7. **Nothing here was measured on the reserved final holdout** (`19,200,000+`), deliberately.
   Per the §J.7 amendment it must appear in exactly one measurement in the whole record.
8. **No new sweep was run and no engine was built for this document.** Every "observed" column
