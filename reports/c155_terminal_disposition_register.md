...
this head stamps **`116f6b45f338620a…`**. The newest sweeps the corpus carries were taken at
...
| C158 (prelude active-slot guard) | `rust/pokezero-search/src/events.rs`, +238 −7 | `116f6b45f338620a…` |
...
**Every measurement behind T2–T6 predates the head build**, and none is at `116f6b45f338620a` —
...
| `t1.head_fingerprint` | 116f6b45f338620a |
