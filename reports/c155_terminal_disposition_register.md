...
this head stamps **`c4add50ab40d9eae…`**. The newest sweeps the corpus carries were taken at
...
| C158 | `rust/pokezero-search/src/events.rs`, +238 −7 | `c4add50ab40d9eae…` |
...
**Every measurement behind T2–T6 predates the head build**, and none is at `c4add50ab40d9eae` —
...
| `t1.head_fingerprint` | c4add50ab40d9eae |
...
| `t3.tie_refusal_line` | rust/pokezero-search/src/events.rs:6156 |
...
| `t4.leftovers_truncated_consumer_line` | rust/pokezero-search/src/events.rs:6228 |
