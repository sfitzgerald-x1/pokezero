...
this head stamps **`04883a24609ab225…`**. The newest sweeps the corpus carries were taken at
...
| C1 Stage 1 (closeout) | `rust/pokezero-search/src/encoder.rs` (131 constant column/offset lookups resolved once at table load) | `04883a24609ab225…` |
...
**Every measurement behind T2–T6 predates the head build**, and none is at `04883a24609ab225` —
...
| `t1.head_fingerprint` | 04883a24609ab225 |
