...
this head stamps **`083375c215978d4c…`**. The newest sweeps the corpus carries were taken at
...
| #1219 completed on #1249 | `rust/pokezero-search/src/encoder.rs` (all 8 per-leaf `format!` md keys → `per_role` `&'static str`) | `083375c215978d4c…` |
...
**Every measurement behind T2–T6 predates the head build**, and none is at `083375c215978d4c` —
nor at `a1359396e3de3731`, `b79d83e3e08d838e`, `bd9f7d407dc3c9a9`,
...
| `t1.head_fingerprint` | 083375c215978d4c |
