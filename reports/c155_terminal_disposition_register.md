...
this head stamps **`d56fd4a545530119…`**. The newest sweeps the corpus carries were taken at
...
legitimate, and it has now happened **five times**. Restricting `git log 7fcd9e19..HEAD` to **all** of
...
exactly five commits. ⚠ **The `input` column is DERIVED, and the third row was wrong on
...
| C157 | `rust/pokezero-search/src/events.rs`, +259 −12 | `d56fd4a545530119…` |
...
`rust/pokezero-search/src/events.rs:5694`, resolved by a unique anchor. So the tie arm is unbuilt at
...
**Every measurement behind T2–T6 predates the head build**, and none is at `d56fd4a545530119` —
nor at `2ec5bfd1c7292ed6`, `028a4c52a4ad9fe7` or `9517aab98d56a9ba`, the builds this document was
reconciled against at the three preceding merges. Read the
...
| `t1.head_fingerprint` | d56fd4a545530119 |
...
| `t3.tie_refusal_line` | rust/pokezero-search/src/events.rs:5694 |
...
| `t4.leftovers_truncated_consumer_line` | rust/pokezero-search/src/events.rs:5766 |
