...
this head stamps **`a1359396e3de3731…`**. The newest sweeps the corpus carries were taken at
...
| C1 Stage 1 (closeout) | `rust/pokezero-search/src/encoder.rs` (131 constant column/offset lookups resolved once at table load) | `a1359396e3de3731…` |
| #1219 completed on #1249 | `rust/pokezero-search/src/encoder.rs` (all 8 per-leaf `format!` md keys → `per_role` `&'static str`) | `a1359396e3de3731…` |
...
**Every measurement behind T2–T6 predates the head build**, and none is at `a1359396e3de3731` —
...
| `t1.head_fingerprint` | a1359396e3de3731 |
