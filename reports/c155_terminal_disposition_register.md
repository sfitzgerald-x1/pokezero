...
this head stamps **`c46d28ae4540d866…`**. The newest sweeps the corpus carries were taken at
...
| #1219 | `rust/pokezero-search/src/encoder.rs`, +29 −6 (five per-leaf `format!` md keys → `&'static str`) | `c46d28ae4540d866…` |
...
**Every measurement behind T2–T6 predates the head build**, and none is at `c46d28ae4540d866` —
...
| `t1.head_fingerprint` | c46d28ae4540d866 |
