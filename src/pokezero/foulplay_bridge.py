        ...
        details.append(
            {
                ...
                "selected_prior": _optional_float(metadata.get("root_puct_selected_action_prior")),
                "search_prior": _optional_float(metadata.get("root_puct_search_action_prior")),
                "prior_prior": _optional_float(metadata.get("root_puct_prior_action_prior")),
